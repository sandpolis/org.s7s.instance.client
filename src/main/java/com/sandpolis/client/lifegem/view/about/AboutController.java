...
import com.sandpolis.client.lifegem.ui.common.label.DateLabel;
...
public class AboutController extends AbstractController {
	...
	private void initialize() throws IOException {
		...
		if (Platform.isSupported(ConditionalFeature.SCENE3D)) {
			...
			MeshView meshView = new MeshView(StlUtil.parse(getClass().getResourceAsStream("/mesh/sandpolis.stl")));
